$(function () {
  ...
  $(window).resize(function () {
    ...
    if (windowSize <= 768) {
      ...
      if (open) {
        $(".menu")
          .css("width", targetSizeMenu + "px")
          .css("padding", "10px 0");
        $(".content,header")
          .css("width", "calc(100% - " + targetSizeMenu + "px)")
          .css("left", targetSizeMenu + "px");
      }
    }
  ...
  $(document).ready(function () {
    ...
    $("#composicaoCorporalTable").DataTable({
      language: {
        url: "https://cdn.datatables.net/plug-ins/2.1.8/i18n/pt-BR.json",
      },
      pageLength: 10, // Define o número de registros por página
    ...
    $("#idosoTable").DataTable({
      language: {
        url: "https://cdn.datatables.net/plug-ins/2.1.8/i18n/pt-BR.json",
      },
      pageLength: 12, // Define o número de registros por página
      select: true,
      responsive: true,
      searching: false,
      ordering: false,
      ...
      autoWidth: false, // Desabilita ajuste automático da largura
      columnDefs: [
        { className: "left", width: "55%", targets: 0 },
        { className: "text-center", width: "15%", targets: 1 },
        { className: "text-center", width: "15%", targets: 2 },
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function calcularSomatorio() {
    ...
    grupos.forEach((grupo) => {
      const media =
        parseFloat(document.getElementById(grupo + "-m").value) || 0;
      somatorio += media;
    });
